...
(defn flip-horiz [p]
  (transform-picture p (make-vec 1 0) (make-vec 0 0) (make-vec 1 1)))

(defn rotate [p]
  (transform-picture p (make-vec 1 0) (make-vec 1 1) (make-vec 0 0)))

(defn rotate180 [p]
  (rotate (rotate p)))

(defn rotate270 [p]
  (transform-picture p (make-vec 0 1) (make-vec 0 0) (make-vec 1 1)))
